		...
		injectedSocket.on('planned-orders', function (data) {
			...
			if (orderLat && orderLon) {
				...
				var orderIcon = new L.DivIcon({
					...
					html: '<img class="imageMarker" src="/images/' +
						iconFileName + '.png"/><span class="markerText">' + data.address + '</span>'
				});
